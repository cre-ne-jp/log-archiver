...
require_relative 'mirc_color_test_data'
...
module LogArchiver
  class MircToHtmlTest < ActiveSupport::TestCase
    ...
    MircColorTestData.load_test_data_set.each do |d|
      data(d.name, [
        d.message,
        d.expected
      ])
    ...
    data '制御文字を出力しない', [
      ...
      " 通常の文字",
      '<span class="mirc-italic mirc-underline mirc-strikethrough mirc-monospace"> 通常の文字</span>'
    ]
