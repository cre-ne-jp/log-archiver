...
ActiveRecord::Schema[7.1].define(version: 2024_01_16_072343) do
  ...
  create_table "archive_reasons", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "reason", default: "", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "archived_conversation_messages", charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga", force: :cascade do |t|
  ...
  create_table "channel_last_speeches", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "channel_id"
  ...
  create_table "channels", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "conversation_messages", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "channel_id"
    t.datetime "timestamp", precision: nil, null: false
    t.string "nick", limit: 64, default: "", null: false
    t.text "message"
  ...
  create_table "irc_users", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga ROW_FORMAT=DYNAMIC", force: :cascade do |t|
  ...
  create_table "keywords", charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=Mroonga", force: :cascade do |t|
  ...
  create_table "message_dates", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "channel_id"
    t.date "date"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "messages", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.integer "channel_id"
    t.integer "irc_user_id", default: 1, null: false
    t.string "type"
    t.datetime "timestamp", precision: nil, null: false
  ...
  create_table "privmsg_keyword_relationships", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "settings", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
